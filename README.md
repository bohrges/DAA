...
This project focuses on analyzing radiomic features extracted from MRI scans of the hippocampus to predict whether individuals with MCI (Mild Cognitive Impairment)  will progress to AD (Alzheimer’s
Disease). The study uses datasets provided by the Alzheimer’s Disease Neuroimaging Initiative (ADNI), preprocessed with the PyRadiomicslibrary. 
